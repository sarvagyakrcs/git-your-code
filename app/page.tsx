  ...
  return (
    <div className="bg-background text-foreground">
      <button
        ...
        className="fixed top-4 right-4 z-50 rounded-full bg-primary p-2 text-primary-foreground"
      >
        Toggle Theme
      </button>
      <main>
          ...
          <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
            <div className="mx-auto max-w-2xl shrink-0 lg:mx-0 lg:pt-8">
              ...
              <div className="mt-10 flex items-center gap-x-6">
                <a
                  href="#"
                  className="rounded-md bg-primary px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
                >
                  Get started
                </a>
              ...
              {primaryFeatures.map((feature) => (
                <div key={feature.name} className="flex flex-col">
                  ...
                  <dd className="mt-1 flex flex-auto flex-col text-base/7 text-muted-foreground">
                    ...
                    <p className="mt-6">
                      <a href={feature.href} className="text-sm/6 font-semibold text-primary">
                        Learn more <span aria-hidden="true">→</span>
                      </a>
                    </p>
                  </dd>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
            <h2 className="text-base/8 font-semibold text-primary">Our track record</h2>
      ...
      <footer className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="border-t border-border py-12 md:flex md:items-center md:justify-between">
          <div className="flex justify-center gap-x-6 md:order-2">
            {footerNavigation.social.map((item) => (
              <a key={item.name} href={item.href} className="text-muted-foreground hover:text-muted-foreground">
