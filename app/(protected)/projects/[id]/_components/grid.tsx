...
import CreateAMeeting from "./create-a-meeting";
        ...
        <div className=" grid gap-4 lg:grid-cols-3 lg:grid-rows-2">
            ...
            <div className="relative max-lg:row-start-1">
                ...
                <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
                    <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                        <p className="mt-2 text-lg font-medium tracking-tight text-gray-950 max-lg:text-center">Ask a Question</p>
                        <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                            { PROJECT_NAME } has complete knowledge of the codebase <Link href={project.githubURL} target="_blank" className="underline">{"@" + project.githubURL.split("/")[project.githubURL.split("/").length - 1] }</Link>
                        </p>
                    </div>
            ...
            <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
                ...
                <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
                    <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                        <p className="mt-2 text-lg font-medium tracking-tight text-gray-950 max-lg:text-center">Create a new meeting</p>
                        <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
