...
const clients: { id: number; name: string; imageUrl: string; lastInvoice: { date: string; dateTime: string; amount: string; status: Status } }[] = [
    {
        id: 1,
        name: 'Tuple',
                                                                ...
                                                                <div className="flex gap-x-6">
                                                                    ...
                                                                    <div className="flex-auto">
                                                                        <div className="flex items-start gap-x-3">
                                                                            ...
                                                                            <div
                                                                                className={classNames(
                                                                                    statuses[transaction.status as Status],
